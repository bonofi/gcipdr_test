...
// newtrap_one_cpp
Rcpp::List newtrap_one_cpp(Rcpp::Function fdist_and_fprime, Rcpp::Nullable<Rcpp::Function> safecheck_arg, double start, double tol, int maxit);
RcppExport SEXP _gcipdrtest_newtrap_one_cpp(SEXP fdist_and_fprimeSEXP, SEXP safecheck_argSEXP, SEXP startSEXP, SEXP tolSEXP, SEXP maxitSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::Function >::type fdist_and_fprime(fdist_and_fprimeSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(newtrap_one_cpp(fdist_and_fprime, safecheck_arg, start, tol, maxit));
...
static const R_CallMethodDef CallEntries[] = {
    {"_gcipdrtest_newtrap_one_cpp", (DL_FUNC) &_gcipdrtest_newtrap_one_cpp, 5},
